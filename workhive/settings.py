"""
Django settings for workhive project.
...
SECRET_KEY = 'django-insecure-+ut%7@-g!wg7_d@7v0=!^d+4ea@uv9_8f-!nm2@uq2co*q^&!('
...
AUTH_USER_MODEL ='backend_crud.User'
...
LOCALE_PATHS = [BASE_DIR / 'locale']  # Create a 'locale' folder in project root
